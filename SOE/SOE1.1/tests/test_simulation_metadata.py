...
def test_parse_xp_uses_simulation_source_side_convention():
...
def test_parse_yp_uses_simulation_source_side_convention():
    metadata = SimulationMetadataParser(
        source_offset_angle_deg=15.0
    ).parse(Path("b1output_gamma_1.000MeV_z1m_yp.root"))
