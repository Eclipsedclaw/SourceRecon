...
On a new machine, configure dependencies once from the V6 root:
...
This automatically builds `../common/libeiid_common.a` if needed. The executable is `EIID_Recon_V6`.
