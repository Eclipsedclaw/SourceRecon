...
- `AbsoluteEfficiencyEstimator`: cone fraction and 4π normalization.
...
Only `cell_index` and `sensitivity` are stored per cell. Scientific/grid metadata is stored once at file level.
