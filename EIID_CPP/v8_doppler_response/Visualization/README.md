...
Visualization is an independent ROOT executable that reads a result ROOT file and truth JSON. V8 preserves V7's model-independent metrics and can inspect either response-kernel result.
