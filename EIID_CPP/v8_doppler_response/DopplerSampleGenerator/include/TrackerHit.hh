...
class TrackerHit : public G4VHit
{
  public:
    ...
    void SetChamberNb(G4int chamber)
    {
      fChamberNb = chamber;
    }

    void SetEdep(G4double energyDeposit)
    {
      fEdep = energyDeposit;
    }
    ...
    void SetPostMomentum(G4ThreeVector momentum)
    {
      fPostMomentum = momentum;
    }
    ...
    void SetCreatorProcess(G4String process)
    {
      fCreatorProcess = process;
    }
    ...
    void SetpostPos(G4ThreeVector position)
    {
      fpostPos = position;
    }

    void SetpostProcess(G4String process)
    {
      fpostProcess = process;
    }
    
    // 🔹 新增阵列编号的 Set 方法
    void SetPixelID(G4int id)
    {
      fPixelID = id;
    }
    ...
    G4double GetPreKineticEnergy() const
    {
      return fPreKineticEnergy;
    }
    ...
    G4ThreeVector PostPos() const
    {
      return fpostPos;
    }

    G4String GetpostProcess() const
    {
      return fpostProcess;
    }
