...
struct PixelIntegrationConfig
{
    // "pixel_center" reproduces V9.  "healpix_subpixel" performs an
    // equal-area average over child-pixel centres.
    std::string strategy;
...
public:
    ...
    const PixelIntegrationConfig& pixelIntegration() const;
...
private:
    ...
    PixelIntegrationConfig pixelIntegration_;
