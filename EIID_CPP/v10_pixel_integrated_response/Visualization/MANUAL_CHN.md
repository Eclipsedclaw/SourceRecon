...
make visualization
make run-visualization          # 顺序绘制四组 V10 重建结果
```
...
V10 提供 `plot_center_nside8_i10.json`、`plot_integrated_nside16_32_i10.json`、`plot_integrated_nside32_64_i10.json` 和 `plot_integrated_nside32_64_i20.json`。推荐使用根目录 `make visualize-pixel-study` 顺序生成全部结果。
