...
Visualization is an independent ROOT executable that reads a result ROOT file and truth JSON. V10 supplies four controlled configurations for the centre baseline, two parent-grid resolutions, and the i10/i20 iteration check. Outputs default to `runs/latest/visualization/<configuration>/`.
