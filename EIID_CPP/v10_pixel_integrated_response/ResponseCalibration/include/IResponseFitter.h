#ifndef EIID_V10_I_RESPONSE_FITTER_H
#define EIID_V10_I_RESPONSE_FITTER_H
...
struct ResponseFitResult
{
    ...
    double estimatedDistanceToMinimum{};
    ...
    double gaussianLorentzianSigmaDegree{};
    double gaussianLorentzianLorentzFwhmDegree{};
    double gaussianLorentzianLorentzWeight{};
};
