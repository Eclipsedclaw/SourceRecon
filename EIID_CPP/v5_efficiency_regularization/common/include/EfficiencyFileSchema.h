#ifndef EIID_V5_EFFICIENCY_FILE_SCHEMA_H
#define EIID_V5_EFFICIENCY_FILE_SCHEMA_H
...
inline constexpr const char* efficiencyDefinition =
    "isotropic_point_source_absolute_detection_efficiency_4pi_jeffreys_regularized";
}
