...
# edited later. Only the V9-generated runs/latest directory may be moved.
...
cp -- "${project_root}/Geant4_Simulation/config/sim_config.json" \
    "${latest}/config_snapshot/"
cp -- "${project_root}/GridResampler/config/resampler_config.json" \
    "${latest}/config_snapshot/"
...
{
    echo "schema=eiid_v9_run_manifest"
...
echo "Fresh V9 run directory prepared at ${latest}"
